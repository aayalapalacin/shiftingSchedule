  ...
  return {
    ...
    actions: {
      getProgram: async () => {
        ...
        try {
          ...
          const resp = await fetch(
            "https://3001-aayalapalac-shiftingsch-vg7ka5dv6po.ws-us74.gitpod.io/api/programs"
          );
      ...
      postProgram: async (
        ...
        try {
          const resp = await fetch(
            "https://3001-aayalapalac-shiftingsch-vg7ka5dv6po.ws-us74.gitpod.io/api/newProgram",
            {
              method: "POST",
